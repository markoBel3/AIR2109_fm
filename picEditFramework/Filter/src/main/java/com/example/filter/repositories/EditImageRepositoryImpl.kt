...
class EditImageRepositoryImpl(private val context: Context) : EditImageRepository {
    ...
    override fun getImageFilters(image: Bitmap): List<ImageFilter> {
        ...
        // Wole
        GPUImageSaturationFilter(2f).also { filter ->
            gpuImage.setFilter(filter)
            imageFilters.add(
                ImageFilter(
                    name = "Wole",
        ...
        GPUImageColorMatrixFilter(
            1.0f,
            floatArrayOf(
                0f, 0f, 0.5183f, 0.3183f,
                0f, 0.5497f, 0.5416f, 0f,
                0.5237f, 0.5269f, 0f, 0f,
                0f, 0f, 0f, 1f
            )
        ).also { filter ->
            gpuImage.setFilter(filter)
